...
export const taaResolveFn = tgpu.computeFn({
  ...
  // Clamped as vec4: the raymarch writes premultiplied RGBA, so alpha has to be
  // constrained by the same neighbourhood as RGB or the two desynchronise at
  // silhouettes and leave a stippled rim.
